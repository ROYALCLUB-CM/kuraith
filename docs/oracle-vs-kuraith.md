...
> อัพเดตล่าสุด — 17 agents, 30 skills, 12 MCP tools, Telegram notifications
...
| **Skills** | **30** (4 subagent + 10 code + 16 markdown) | **30** — recap, forward, learn, trace, feel, awaken, note, dig, rrr, standup, who-are-you, watch, focus, reflect, status, sync, deep-research, birth, philosophy, speak, about, promote, export, timeline, connect, review, broadcast, plan, mission, goodbye |
| **Profiles** | 3 — seed (6), standard (13), full (30) | 3 — seed (7), standard (16), full (30) |
| **Installer** | `curl \| bash` (pre-built binary, 37ms startup) | `bash install.sh` (shell script) |
| **Auto-detect agents** | ✅ | ✅ |

**วิเคราะห์**: เท่ากันทุกด้าน — 17 agents, 30 skills, 3 profiles
...
|---|---------|-----------|---------|
| 1 | Binary installer | Pre-built binary (37ms startup) | ยาก |
| 2 | Git worktree workspace | Agent แต่ละตัวได้ branch + working dir แยก | ปานกลาง |
| 3 | Hermes routing | Auto-select agent ตาม context | ยาก |
| 4 | Multi-instance | หลาย KURAITH เฉพาะทาง | ยาก |
...
| 13 | Telegram notifications | Push notifications สำหรับ handoff, learn, workflow events |
...
| Priority 1: +9 agents, +20 skills | ✅ Done (17 agents, 30 skills) |
| Priority 2: Telegram Bot | ✅ Done (handoff, learn, workflow notifications) |
| Priority 3: Deploy + Launch | 🔜 Next (need server) |
| Priority 4: Git worktree integration | 📋 Planned |
| Priority 5: Hermes-style routing | 📋 Planned |
| Priority 6: Multi-instance | 📋 Planned |
